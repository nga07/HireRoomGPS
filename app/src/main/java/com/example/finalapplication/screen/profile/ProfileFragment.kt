...
import com.example.finalapplication.screen.favorite.FavoriteActivity
import com.example.finalapplication.screen.login.LoginActivity
import com.example.finalapplication.screen.mypost.MyPostActivity
...
class ProfileFragment : BaseFragment<FragmentProfileBinding>(FragmentProfileBinding::inflate) {
    ...
    override fun handleEvent() {
        binding.apply {
                    ...
                    .setPositiveButton(
                        ...
                        val gso =
                            GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                                .requestEmail().build()
                        val gsc = context?.let { it1 -> GoogleSignIn.getClient(it1, gso) }
                        gsc?.signOut()
            ...
            buttonMyPost.setOnClickListener {
                val intent = Intent(context, MyPostActivity::class.java)
                startActivity(intent)
            }
            buttonMyFavorite.setOnClickListener {
